...
class PranikSifaComments extends Base {
  ...
  PranikSifaComments(super.glob, this.form){
    title = glob.content.isA("comm1_title");
    backUrl = glob.content.isADyn("consultancies")[0]["url"];
  }
